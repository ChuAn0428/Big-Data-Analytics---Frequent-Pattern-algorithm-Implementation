...
###########################
 ...
 5. This program impliments Apriori algorithm, which is a relatively slower but intuitive approach. Here are the run time tested for operations with different parameters using Ubuntu 18.04 LTS:
